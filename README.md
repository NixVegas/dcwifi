...
|nixVegas.dcWifi.passwordTemplate|`"<random:16-24>"`|Template to use for the password. Only template helper supported is "random", with an argument for the number of characters to generate (this will generate a 16-24 character random password for you via openssl)|
